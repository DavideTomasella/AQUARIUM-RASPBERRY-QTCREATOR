...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_calibrate_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 43, 15)
    ...
    "calibrate\0updateCalState\0\0startCalibration\0"
    "stopCalibration"
};
...
void calibrate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->updateCalState(); break;
...
const QMetaObject calibrate::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_calibrate.data,
      qt_meta_data_calibrate,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_calibrate.stringdata))
