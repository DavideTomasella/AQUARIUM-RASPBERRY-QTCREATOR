...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DataParser_t, stringdata) + ofs \
...
const QMetaObject DataParser::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DataParser.data,
      qt_meta_data_DataParser,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DataParser.stringdata))
        return static_cast<void*>(const_cast< DataParser*>(this));
